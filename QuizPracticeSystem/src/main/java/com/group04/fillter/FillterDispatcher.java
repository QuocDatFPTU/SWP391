    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (session == null) {
                ...
                //check session co chua user da login chua
            ...
            //xong 
            if (!registered) {
                // tl chua dc dang nhap
                //kt resouce co trong list memberfunction
                if (listMemberFunction.contains(resource)) {
