<%-- Document : subjectlist Created on : Jul 16, 2021, 7:52:41 PM Author : ntdun --%>
    <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <link rel="stylesheet" href="css/courseListStyling.css">
        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <a class="navbar-brand" href="#">
                    <img src="img/q (1).svg" alt="Q logo " width="40px;" height="50px;" /></a>
            ...
            <section id="page-banner" class="pt-105 pb-110 bg_cover mt-5" data-overlay="8"
                style="background-image: url('/img/page-banner-2.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
            ...
            <div class="course-content">
                <div class="container">
                    <div class="row justify-content-evenly">
                        <!-- 1 -->
                        <c:set var="subjectList" value="${sessionScope.listSubjectPaging}" />
                        <c:forEach var="subject" items="${subjectList}">
                            <div class="col-lg-3 col-md-3 ml-8 mr-8 mt-5 course-wrapper">
                                <div class="single-course">
                                    <div class="thum">
                                        <img src="img/asp-mvc.jpg" alt="course">
                                    </div>
                                    <div class="course-properties">
                                        <div class="course-caption">
                                            <p class="mt-4">${subject.category}</p>
                                            <h3><a href="#">${subject.subjectName}</a></h3>
                                        </div>
                                    ...
                                    <div class="row ">
                                        <div class="col-md-4">
                                            <a href="#" class="btn btn-sm animated-button thar-two ">Purchase</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 second-col">
                        ...
                        <ul>
                            ...
                            <li>
                                <i class="fas fa-chevron-right" style="color: aliceblue"></i><a href="">Course</a>
                            </li>
                            <li>
                                <i class="fas fa-chevron-right" style="color: aliceblue"></i><a href="">Blog</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="location-footer">
                                    <p>
                                        L� E2a-7, ???ng D1, Khu C�ng Ngh? Cao, Long Th?nh M?, Qu?n 9,
                                        Th�nh ph? H? Ch� Minh
                                    </p>
                                </div>
                            </li>
