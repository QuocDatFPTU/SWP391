  ...
  <div style="border: solid blue; padding: 1rem;">
    <div class="container">
      ...
      <div class="d-flex flex-row-reverse">
        ...
        <div class="p-2">
          <div style="font-size: 30px">1/20</div>
        </div>
      </div>
    </div>
    <hr>
    ...
    <div class="questionDetail">
      <div>
        ...
        <form action="/action_page.php">
          <input type="checkbox" id="Ans1" name="Ans1" />
          <label for="Ans1"> Ans1</label><br />
          <input type="checkbox" id="Ans2" name="Ans2" />
          <label for="Ans2"> Ans2</label><br />
          <input type="checkbox" id="Ans3" name="Ans3" />
          <label for="Ans3"> Ans3</label><br />
          <input type="checkbox" id="Ans4" name="Ans4" />
          <label for="Ans4"> Ans4</label><br />
        </form>
      </div>
      <div style="margin-top: 10rem;">
        ...
        <div class="container-fluid d-flex bg-success text-white" style="margin-top: 10px; padding: 1rem;">
          ...
          <button type="button" class="btn btn-outline-light ml-auto p-2" style="width: 10rem;">Next</button>
        </div>
        <!-- Modal -->
